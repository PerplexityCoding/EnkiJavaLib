...
public class LaTeX {
	...
	public static Logger log = LoggerFactory.getLogger(LaTeX.class);
    ...
    private static String mungeLatex(Deck deck, String latex) {
        ...
        while (namedEntity.find()) {
        	// FIXME: test Jsoup instead for Android Html.fromText
            sb.replace(namedEntity.start(), namedEntity.end(), Jsoup.parse(namedEntity.group()).text());
